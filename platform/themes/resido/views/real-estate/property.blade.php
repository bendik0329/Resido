...
@endphp
@php $img = $property->images ? $property->images[1] : 'img-loading.jpg' @endphp
                                ...
                                <div class="sides_list_property_detail custom_sides_list_property_detail">
                                    ...
                                    <div class="lists_property_price">
                                        ...
                                        <div class="lists_property_price_value">
                                            <h4>
                                                <del>{{$reproperty->currency->symbol}}{{ number_format($reproperty->price) }}</del>@if($reproperty->type->slug == 'rent') / {{$reproperty->period}} @endif <br>
                                                {{$reproperty->currency->symbol}}{{number_format($reproperty->discount_rate)}} @if($reproperty->type->slug == 'rent') / {{$reproperty->period}} @endif
                                            </h4>
                                        </div>
                                    </div>
                                </div>
