...
<div class="property-listing property-1 {{ $class_extend ?? '' }}"
    ...
    <div class="listing-img-wrapper">
		...
		<div>
            ...
            <span class="prt-types urgent" style="position: absolute;top: 3px; right: 4px;">{{ __('Urgent') }}</span>
            @endif
        </div>
    </div>
            ...
            <div class="listing-detail-wrapper">
                ...
                <div class="list-price">
                    <div>
                        ...
                        <span class="prt-types {{ $property->type->slug }}" style="background: #868ee7;">{{ __('Top Property') }}</span>
                        @endif

                        @if($property->is_featured == 1)
                        <span class="prt-types {{ $property->type->slug }}" style="background: #868ee7;">{{ __('Featured') }}</span>
                        @endif
					    
                    </div>
                    <h6 class="listing-card-info-price-list">
