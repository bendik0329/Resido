        ...
        <div class="col">
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td width="50%">{{ trans('plugins/payment::subscribe.discount_price') }}</td>
                        <td width="50%">{{ $package->is_allow_discount ? trans('plugins/payment::subscribe.available_text') : trans('plugins/payment::subscribe.not_available_text') }}</td>
                    </tr>
                    <tr>
