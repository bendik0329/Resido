        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                               for="sold_property_show_days">{{ trans('plugins/real-estate::settings.sold_property_show_days') }}
                        </label>
                        <input type="number" class="form-control" name="sold_property_show_days" value="{{ RealEstateHelper::soldPropertyShowDays() }}">
                    </div>
                </div>
            </div>
        </div>
