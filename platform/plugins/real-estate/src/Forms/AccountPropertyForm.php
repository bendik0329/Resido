...
class AccountPropertyForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $selectedTypes = '';
        if ($this->getModel()) {
            $selectedTypes = $this->getModel()->type()->pluck('re_property_types.id')->first();
        }
        ...
        $this
            ...
            ->addMetaBoxes([
                'type_id'   => [
                    ...
                    'content'  => view('plugins/real-estate::partials.form-types',
                        compact('types','selectedTypes'))->render(),
            ...
            ->add('discount_rate', 'number', [
                'label'      => trans('plugins/real-estate::property.form.discount_rate'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 col-md-3 ' . (isset($activePackage['is_allow_discount']) && $activePackage['is_allow_discount'] ? '' : 'hidden'),
                ],
                'attr'       => [
                    'placeholder' => trans('plugins/real-estate::property.form.discount_rate'),
                ],
            ])
            ...
            ->add('is_sold', 'onOff', [
                'label'         => trans('plugins/real-estate::property.form.is_sold'),
                'label_attr'    => ['class' => 'control-label'],
                'default_value' => false,
            ])
